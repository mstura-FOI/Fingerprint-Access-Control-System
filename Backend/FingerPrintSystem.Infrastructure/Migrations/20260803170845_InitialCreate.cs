        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KekKeyId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BiometricTemplates_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OneTimeCodes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessRights_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CertThumbprint = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    RoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomShifts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomShifts_AspNetUsers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomShifts_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomShifts_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FingerprintScans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FingerprintScans_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FingerprintScans_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRights_ApplicationUserId_RoomId",
                table: "AccessRights",
                columns: new[] { "ApplicationUserId", "RoomId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ApplicationUserId_AttendanceDateTime",
                table: "Attendances",
                columns: new[] { "ApplicationUserId", "AttendanceDateTime" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BiometricTemplates_ApplicationUserId",
                table: "BiometricTemplates",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Devices_CertThumbprint",
                table: "Devices",
                column: "CertThumbprint",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FingerprintScans_ApplicationUserId",
                table: "FingerprintScans",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_FingerprintScans_DeviceId_ScanTime",
                table: "FingerprintScans",
                columns: new[] { "DeviceId", "ScanTime" });

            migrationBuilder.CreateIndex(
                name: "IX_FingerprintScans_ScanTime",
                table: "FingerprintScans",
                column: "ScanTime");

            migrationBuilder.CreateIndex(
                name: "IX_OneTimeCodes_ApplicationUserId_Purpose",
                table: "OneTimeCodes",
                columns: new[] { "ApplicationUserId", "Purpose" });

            migrationBuilder.CreateIndex(
                name: "IX_OneTimeCodes_CodeHash",
                table: "OneTimeCodes",
                column: "CodeHash");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_ManagerId",
                table: "RoomShifts",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_RoomId",
                table: "RoomShifts",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomShifts_ShiftId",
                table: "RoomShifts",
                column: "ShiftId");
        }
